        ...
        //    if (!PauseMenu.gameIsPaused)
        {
            if (playerID == 0)
            {
                ...
                if (KB)
                {
                    ...
                    if (Input.GetButtonDown("KB_CROSS")) Jump();
                    ...
                    if (Input.GetButtonDown("KB_TRIANGLE") && Input.GetAxis("KB_Horizontal") == 0 && Input.GetAxis("KB_Vertical") == 0) NSpecial();
                    if (Input.GetButtonDown("KB_TRIANGLE") && Input.GetAxis("KB_Horizontal") != 0 && Input.GetAxis("KB_Vertical") == 0) NSpecial();
                    ...
                    if (Input.GetButtonDown("KB_SQUARE") && Input.GetAxis("KB_Horizontal") == 0 && Input.GetAxis("KB_Vertical") == 0 && !Input.GetButtonDown("KB_CIRCLE")) NAttack();
                    ...
                    if (Input.GetButtonDown("KB_SQUARE") && Input.GetAxis("KB_Vertical") > 0 && !Input.GetButtonDown("KB_CIRCLE")) UAttack();
                ...
                if (XBOX)
                {
                    ...
                    if (Input.GetButtonDown("XB_CROSS")) Jump();
                    if (Input.GetButtonDown("XB_SQUARE")) NAttack();
                    if (Input.GetButtonDown("XB_TRIANGLE")) UAttack();
                    if (Input.GetButtonDown("XB_CIRCLE")) NSpecial();
            ...
            else if (playerID == 1)
            {
                ...
                if (KB)
                {
                    ...
                    if (Input.GetButtonDown("KB_CROSS_2")) Jump();
                    ...
                    if (Input.GetButtonDown("KB_TRIANGLE_2") && Input.GetAxis("KB_Horizontal_2") == 0 && Input.GetAxis("KB_Vertical_2") == 0) NSpecial();
                    if (Input.GetButtonDown("KB_TRIANGLE_2") && Input.GetAxis("KB_Horizontal_2") != 0 && Input.GetAxis("KB_Vertical_2") == 0) NSpecial();
                    ...
                    if (Input.GetButtonDown("KB_SQUARE_2") && Input.GetAxis("KB_Horizontal_2") == 0 && Input.GetAxis("KB_Vertical_2") == 0 && !Input.GetButtonDown("KB_CIRCLE_2")) NAttack();
                    ...
                    if (Input.GetButtonDown("KB_SQUARE_2") && Input.GetAxis("KB_Vertical_2") > 0 && !Input.GetButtonDown("KB_CIRCLE_2")) UAttack();
                ...
                if (XBOX)
                {
                    if (Input.GetButtonDown("XB_CROSS_2")) Jump();
                    if (Input.GetButtonDown("XB_SQUARE_2")) NAttack();
                    if (Input.GetButtonDown("XB_TRIANGLE_2")) UAttack();
                    if (Input.GetButtonDown("XB_CIRCLE_2")) NSpecial();
                }
